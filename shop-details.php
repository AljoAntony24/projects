                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Plants Details</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            <h4 class="title"><?php echo"<a style='font-size:18px' href='shop-details.php?prod_id=".$user_data['prod_id']."'>".$user_data['prod_name']."</a>"; ?></h4>
                            <h4 class="price"><?php echo"<a style='font-size:15px' href='shop-details.php'>".$user_data['prod_price']."</a>"; ?></h4>
                            <div class="short_overview">
                                <p><?php echo"<a style='font-size:16px' href='shop-details.php'>".$user_data['prod_desc']."</a>"; ?></p>
                            </div>
